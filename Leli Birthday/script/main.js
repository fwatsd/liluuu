  ...
  if (btn) {
    ...
    btn.addEventListener("click", function () {
      Swal.fire({
        ...
        html: '<strong>Mau jadi temen hidup aku selamanya nggak? 💞</strong><br><em>(jangan lupa di-skrinsut jawabannya yaa 😆)</em>',
        icon: 'question',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
          Swal.fire('Yeyyy!', 'Aku juga mau selamanya bareng kamu! 💖', 'success');
        } else {
          Swal.fire('Hiks', 'Gapapa sih... tapi aku sedih 😔', 'error');
        }
      });
    });
  }
